...
public class Album {
	...
	private void initUI() {
		...
		ImageView album_delete = (ImageView) albumView.findViewById(R.id.album_delete);
		album_delete.setOnClickListener(new OnClickListener() {
		...
		albumView.setOnTouchListener(new SwipeToDismissListener(albumView, null, new SwipeToDismissListener.DismissCallback() {
			@Override
